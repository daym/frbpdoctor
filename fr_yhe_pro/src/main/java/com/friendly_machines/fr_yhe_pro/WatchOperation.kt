...
enum class WatchOperation(val code: Short) {
    ...
    SSetTime(0x0100), SAlarm(0x0101), SGoal(0x0102), SUserInfo(0x0103), SUnit(0x0104), SSetWearingHand(0x0108), SNotification(0x010A), SFindPhone(0x010D), SRestoreFactory(0x010E), SSetDnd(0x010F), SSetLanguage(0x0112), SRaiseScreen(0x0113), SDisplayBrightness(0x0114), SSetMainTheme(0x0119), SGetChipScheme(0x011B), SSetScheduleSwitch(0x0129), SSetUploadReminder(0x012B), SRegularReminder(0x013D), // etc
    ...
    // TODO 0xd75 (arg: byte 4; or bytes 128, type, 0)

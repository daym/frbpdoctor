...
class SleepFragment : Fragment() {
    ...
    private var activeController: SleepHistoryController? = null
    ...
    private fun toggleSync() {
        activeController?.let { controller ->
            ...
            val controller = SleepHistoryController.collect(
    ...
    private fun updateButtonState() {
        val isActive = HistoryControllerRegistry.isOperationActive(
            SleepHistoryController.RESPONSE_TYPES, 
            SleepHistoryController.MED_BIG_RESPONSE_TYPES
        )

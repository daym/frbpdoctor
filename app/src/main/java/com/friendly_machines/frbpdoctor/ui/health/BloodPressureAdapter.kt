...
class BloodPressureAdapter(private val data: List<com.friendly_machines.fr_yhe_api.commondata.HBloodDataBlock>) : RecyclerView.Adapter<BloodPressureViewHolder>() {

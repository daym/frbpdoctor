...
class AllSensorFragment : Fragment() {
    private lateinit var recyclerView: RecyclerView
    private lateinit var syncButton: Button
    private var activeController: AllHistoryController? = null

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_all_sensor, container, false)
    }
    ...
    private fun toggleSync() {
        activeController?.let { controller ->
            ...
            val controller = AllHistoryController.collect(
    ...
    private fun updateButtonState() {
        val isActive = HistoryControllerRegistry.isOperationActive(
            AllHistoryController.RESPONSE_TYPES, 
            AllHistoryController.MED_BIG_RESPONSE_TYPES
        )

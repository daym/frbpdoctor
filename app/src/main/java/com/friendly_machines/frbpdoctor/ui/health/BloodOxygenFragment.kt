...
class BloodOxygenFragment : Fragment() {
    ...
    private var activeController: BloodOxygenHistoryController? = null

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_blood_oxygen, container, false)
    }
    ...
    private fun toggleSync() {
        activeController?.let { controller ->
            ...
            val controller = BloodOxygenHistoryController.collect(
    ...
    private fun updateButtonState() {
        val isActive = HistoryControllerRegistry.isOperationActive(
            BloodOxygenHistoryController.RESPONSE_TYPES, 
            BloodOxygenHistoryController.MED_BIG_RESPONSE_TYPES
        )

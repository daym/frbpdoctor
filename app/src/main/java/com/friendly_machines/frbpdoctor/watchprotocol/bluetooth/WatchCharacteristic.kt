...
object WatchCharacteristic {
    ...
    fun decodeMessage(buf: ByteBuffer): WatchRawResponse {
        ...
        val ackedSequenceNumber = buf.int // That's the serial number of the package that we had sent to the watch
        ...
        return WatchRawResponse(
            sequenceNumber, ackedSequenceNumber, command, ByteArray(0)
        )
    }
